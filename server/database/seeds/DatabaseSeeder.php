...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            '4|SYNC_HASH|Hash последней синхронизации. Позволяет отследить изменения, которые были внесены в БД после синхронизации и напоминать администратору, что нужно выполнить синхронизацию.|',
