...
<a href="#" class="dropdown-item" onclick="hostAdd(); return false;">@lang('admin/hubs.camcorder_host_add')</a>
@endsection
    ...
    <table id="hosts_table" class="table table-sm table-hover table-bordered table-fixed-header">
        <thead>
            <tr>
                ...
                <th scope="col" style="width: 150px;"><span>@lang('admin/hubs.host_NAME')</span></th>
...
<script>
    ...
    function hostAdd() {
        dialog('{{ route("admin.hub-camcorderhost-edit", ["hubID" => $hubID, "id" => -1]) }}');
    }
    
    function hostEdit(id) {
        dialog('{{ route("admin.hub-camcorderhost-edit", ["hubID" => $hubID, "id" => ""]) }}/' + id);
    }
